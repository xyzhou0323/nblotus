...
- **5月2日**
    ...
    成立【翻译小组】，启动 [Aspie Quiz V5](https://rdos.net/china/) 量表的翻译工作（详见页面[测试丨Aspie Quiz V5 中文版]({{% relref "/docs/resource/aspiequiz" %}})，翻译志愿者：Alexander Ma马张骏骐、蓝俊雄、欧阳睿泽、XyZ。
...
- **10月1日**
    ...
    完成[翻译丨神经殊异友好的DBT练习册]({{% relref "/docs/resource/dbtworkbook" %}})的翻译、排版和发布，翻译志愿者：Admin 、XyZ 、小呆、披垒、Guillotine、明月潮生，专业审阅：韦亦然，小红书排版：XyZ。
